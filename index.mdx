...
description: This is where I keep code snippets, opinions and ideas about computer related tools, amongst other things that concern topics of interest.
---

This is where I keep code snippets, opinions and ideas about computer related tools, amongst other things that
concern topics of interest.

## Manifesto

* *Simple* is better than complex.
* *Choices* depend on the human, legacy, time and market contexts.
* *Honesty* beats vanity on the long term.
* *Tools* are means, not goals.
* *Value* is what the customer gets.

(see also the [manifesto for agile software development](https://agilemanifesto.org/), the [manifesto for software craftsmanship](https://manifesto.softwarecraftsmanship.org/) and the [zen of python](https://www.python.org/dev/peps/pep-0020/#the-zen-of-python))
...
The aim is purely non-commercial, and although commercial products are listed in some pages, I do not endorse any of
