---
title: Financements
description: "Notes sur le financement d'une jeune entreprise en France : dispositifs BPI et incubateurs, concours, CIR / CII / JEI, projets collaboratifs."
---

> **Notes anciennes.** La mécanique générale décrite ici (qui finance quoi, contre quelles
> contreparties) bouge peu. Les montants, les seuils et les noms de dispositifs, eux, ont
> changé : le programme européen H2020 s'est terminé
> en 2020 et a laissé la place à Horizon Europe (2021-2027), et l'exonération d'impôt sur les
> bénéfices du statut JEI est désormais réservée aux entreprises créées avant le 31 décembre 2023,
> une nouvelle catégorie « jeune entreprise d'innovation à impact » ayant été créée par la loi de
> finances pour 2026. Vérifier chaque chiffre auprès de [Bpifrance](https://www.bpifrance.fr/) ou du
> [BOFiP](https://bofip.impots.gouv.fr/) avant de s'en servir.

## Mécanismes via BPI / Incubateurs

### À destination des jeunes entreprises
...
* PIA1 (incubateurs labellisés, 30k en subvention, en général 18k accompagnement et 12k en loyer)

  * un des rares dispositifs non conditionné aux fonds propres (en général ok si 15k de fonds propres)
  * avantage, pas besoin de taper à la porte de BPI, il suffit de pousser la porte d'un incubateur (labellisé)
...
* Prêts d'Amorçage
  ...
  * taux ~5%
  * fait à l'occasion d'une levée de fonds, apparaissant plutôt certaines, il faut de vraies marques d'intérêt
  * dépend du niveau de fond propres, montant levés, qualité techno, ...
  * si levée avec un partenaire industriel/business, s'ils n'ont pas de véhicule d'investissement, cela peut être un no-go des PA car on peut être considéré comme quasi-filiale si >25%.
...
Définition simplifiée : Je crée de la techno (pas forcément numérique), et je démontre que dans l'état de l'art (académique) je n'ai pas de réponse. Notion de difficulté, d'incertitude : je ne suis pas sûr d'y arriver.
...
* exonération fiscale sur les premiers exercices bénéficiaires
* Rescrit
...
* Rescrit CIR : à éviter, car pas de recours, alors que sur un contrôle il y a des recours.
...
* Clôture au 31.12 plus confortable
* Depuis 2013
* critères innovation plutôt que r&d.
...
* Europe : Horizon Europe (2021-2027), qui a remplacé H2020
...
* Penser à immobiliser la R&D, c'est un artifice comptable mais ça permet d'optimiser les ratios comptables qui peuvent tout changer, l'UE impose des calculs de ratios qui peuvent imposer un NOGO aux banques.
